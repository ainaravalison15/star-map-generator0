...
var baseConfig = {
  ...
  stars: {
    ...
    limit: 9, // Show only stars brighter than limit magnitude
    ...
    size: 20, // Maximum size (radius) of star circle in pixels
...
const FONT = "font-family: 'Noto Sans Arabic', sans-serif;";
...
const config = {
  ...
  constellations: {
    ...
    nameStyle: {
      ...
      align: "center",
      baseline: "middle",
      font: [`20px ${FONT}`, `8px ${FONT}`, `0px ${FONT}`]
    },
    lines: true,
